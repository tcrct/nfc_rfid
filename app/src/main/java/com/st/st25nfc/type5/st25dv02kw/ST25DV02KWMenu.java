...
public class ST25DV02KWMenu extends ST25Menu {
    public ST25DV02KWMenu(NFCTag tag) {
        super(tag);
        mMenuResource = new int[3];
        mMenuResource[0] = R.menu.menu_home;
        mMenuResource[1] = R.menu.menu_nfc_forum;
        mMenuResource[2] = R.menu.menu_st25dv02kw;
    }
...
//                break;
            ...
            case R.id.tag_info:
                ...
                intent = new Intent(activity, ST25DV02KWActivity.class);
...
//                break;
            ...
            case R.id.area_security_status_management:
                ...
                activity.startActivityForResult(intent, 1);
                break;
            case R.id.pwm_rw_access_rights:
                intent = new Intent(activity, ST25DV02KWPwmPasswordActivity.class);
                activity.startActivityForResult(intent, 1);
                break;
            case R.id.pwm_ctrl_configuration:
                intent = new Intent(activity, ST25DV02KWPwmCtrlConfigurationActivity.class);
                activity.startActivityForResult(intent, 1);
                break;
            case R.id.pwm_ctrl:
                intent = new Intent(activity, ST25DV02KWPwmCtrlActivity.class);
                activity.startActivityForResult(intent, 1);
                break;
