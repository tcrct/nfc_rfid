...
public class ST25TAMenu extends ST25Menu {
    public ST25TAMenu(NFCTag tag) {
        ...
        mMenuResource[2] = R.menu.menu_st25ta_counter;
        // Add GPO to the counter feature
        if (tag instanceof ST25TA02KPTag || tag instanceof ST25TA02KDTag) {
            mMenuResource[0] = R.menu.menu_home;
            mMenuResource[1] = R.menu.menu_nfc_forum;
            mMenuResource[2] = R.menu.menu_st25ta_gpo;
