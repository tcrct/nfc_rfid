...
//    private EditText mNbrOfBytesEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View childView = getLayoutInflater().inflate(R.layout.fragment_read_memory, null);
...
//        mNbrOfBytesEditText.setText("64");
...
//            TextView asciiValueTextView = (TextView) listItem.findViewById(R.id.asciiValueTextView);
            ...
            int value = -1;
            try {
                value = Helper.convertHexStringToInt(byte1Str);
            ...
            if(value > 0 && value < 256) {
                String startAddress = String.format("%s: %3d ", getResources().getString(R.string.addr), value);
            ...
            try {
//                System.out.println(Helper.convertHexStringToInt(data));
//                Log.i("byte1Str", ""+Helper.convertHexStringToInt(byte1Str));
                int value = Helper.convertHexStringToInt(byte1Str);
                if(value < 0 || value > 255) {
                    showToast(R.string.Card_Number_failed);
                }
                Log.i("byte1Str", ""+value);
                hexValuesTextView.setText(""+value);
//                hexValuesTextView.setText(Helper.convertHexStringToInt(byte1Str));
